...
from core.user.forms import Country, CountryForm
from core.security.mixins import AccessModuleMixin, PermissionModuleMixin


class CountryListView(AccessModuleMixin, PermissionModuleMixin, ListView):
    model = Country
...
class CountryCreateView(AccessModuleMixin, PermissionModuleMixin, CreateView):
    model = Country
...
class CountryUpdateView(AccessModuleMixin, PermissionModuleMixin, UpdateView):
    model = Country
    template_name = 'country/create.html'
    form_class = CountryForm
    success_url = reverse_lazy('country_list')
...
class CountryDeleteView(AccessModuleMixin, PermissionModuleMixin, DeleteView):
    model = Country
