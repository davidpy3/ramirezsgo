...
from core.user.forms import Province, ProvinceForm
from core.security.mixins import AccessModuleMixin, PermissionModuleMixin


class ProvinceListView(AccessModuleMixin, PermissionModuleMixin, ListView):
    model = Province
...
class ProvinceCreateView(AccessModuleMixin, PermissionModuleMixin, CreateView):
    model = Province
...
class ProvinceUpdateView(AccessModuleMixin, PermissionModuleMixin, UpdateView):
    model = Province
    template_name = 'province/create.html'
    form_class = ProvinceForm
    success_url = reverse_lazy('province_list')
...
class ProvinceDeleteView(AccessModuleMixin, PermissionModuleMixin, DeleteView):
    model = Province
