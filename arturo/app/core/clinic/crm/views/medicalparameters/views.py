...
from core.clinic.crm.forms import MedicalParameters, MedicalParametersForm
from core.security.mixins import AccessModuleMixin, PermissionModuleMixin


class MedicalParametersListView(AccessModuleMixin, PermissionModuleMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['title'] = 'Listado de Parametros Medicos'
        return context


class MedicalParametersCreateView(AccessModuleMixin, PermissionModuleMixin, CreateView):
    model = MedicalParameters
...
class MedicalParametersUpdateView(AccessModuleMixin, PermissionModuleMixin, UpdateView):
    model = MedicalParameters
    template_name = 'medicalparameters/create.html'
    form_class = MedicalParametersForm
    success_url = reverse_lazy('medicalparameters_list')
...
class MedicalParametersDeleteView(AccessModuleMixin, PermissionModuleMixin, DeleteView):
    model = MedicalParameters
