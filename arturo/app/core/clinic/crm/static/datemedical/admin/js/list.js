    ...
    tblDateMedical = $('#data').DataTable({
        ...
        columnDefs: [
            ...
            },
            {
                ...
                class: 'text-center',
                render: function (data, type, row) {
                    var buttons = '<a class="btn btn-danger btn-xs btn-flat" href="/clinic/crm/date/medical/admin/delete/'+row.id+'/" data-toggle="tooltip" title="Eliminar"><i class="fas fa-trash"></i></a> ';
                    if (row.status.id === 'activo') {
                        buttons += '<a class="btn btn-success btn-xs btn-flat" href="/clinic/crm/date/medical/admin/update/'+row.id+'/" data-toggle="tooltip" title="Atender"><i class="fas fa-stethoscope"></i></a> ';
                        buttons += '<a class="btn btn-warning btn-xs btn-flat" data-toggle="tooltip" title="Cancelar" rel="cancel"><i class="fas fa-times"></i></a> ';
                    }
                    buttons += '<a class="btn btn-info btn-xs btn-flat" data-toggle="tooltip" title="Detalles" rel="det"><i class="fas fa-folder-open"></i></a> ';
                    buttons += '<a href="/clinic/crm/date/medical/admin/print/'+row.id+'/" target="_blank" class="btn btn-secondary btn-xs btn-flat" data-toggle="tooltip" title="Imprimir"><i class="fas fa-file-pdf"></i></a> ';
                    return buttons;
                }
            },
        ],
