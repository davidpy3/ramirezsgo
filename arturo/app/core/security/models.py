        ...
        try:
            ...
            if group_id != 0:
                listmodules = self.module_set.filter(is_active=True, is_vertical=True,
                                                     groupmodule__groups_id=group_id).order_by('name')
        except:
            pass
        return listmodules
...
class Module(models.Model):
    ...
    moduletype = models.ForeignKey(ModuleType, null=True, blank=True, verbose_name='Tipo de Módulo', on_delete=models.CASCADE)
