...
urlpatterns = [
    # module_type
    path('module/type/', ModuleTypeListView.as_view(), name='moduletype_list'),
    path('module/type/add/', ModuleTypeCreateView.as_view(), name='moduletype_create'),
    path('module/type/update/<int:pk>/', ModuleTypeUpdateView.as_view(), name='moduletype_update'),
    path('module/type/delete/<int:pk>/', ModuleTypeDeleteView.as_view(), name='moduletype_delete'),
    # module
